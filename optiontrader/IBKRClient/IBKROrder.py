...
class IBKROrder:
    ...
    @staticmethod
    def Discretionary(action: str, 
                      quantity: Decimal, 
                      price: float, 
                      discretionaryAmount: float) -> Order:
    ...
    @staticmethod
    def MarketIfTouched(action: str, 
                        quantity: Decimal, 
                        price: float) -> Order:
    ...
    @staticmethod
    def Midprice(action:str, 
                 quantity:Decimal, 
                 priceCap:float)  -> Order:
    ...
    @staticmethod
    def PeggedToMarket(action:str, 
                       quantity:Decimal, 
                       marketOffset:float)  -> Order:
    ...
    @staticmethod
    def PeggedToStock(action:str, 
                      quantity:Decimal, 
                      delta:float, 
                      stockReferencePrice:float, 
                      startingPrice:float)  -> Order:
    ...
    @staticmethod
    def RelativePeggedToPrimary(action:str, 
                                quantity:Decimal, 
                                priceCap:float, 
                                offsetAmount:float)  -> Order:
    ...
    @staticmethod
    def AuctionLimit(action:str, 
                     quantity:Decimal, 
                     price:float, 
                     auctionStrategy:int) -> Order:
    ...
    @staticmethod
    def AuctionPeggedToStock(action:str, 
                             quantity:Decimal, 
                             startingPrice:float, 
                             delta:float) -> Order:
    ...
    @staticmethod
    def AuctionRelative(action:str, 
                        quantity:Decimal, 
                        offset:float) -> Order:
    ...
    @staticmethod
    def LimitOrderWithCashQty(action:str, 
                              limitPrice:float, 
                              cashQty:float) -> Order:
    ...
    @staticmethod
    def LimitIfTouched(action:str, 
                       quantity:Decimal, 
                       limitPrice:float, 
                        triggerPrice:float) -> Order:
    ...
    @staticmethod
    def PassiveRelative(action:str, 
                        quantity:Decimal, 
                        offset:float) -> Order:
    ...
    @staticmethod
    def PeggedToMidpoint(action:str, 
                         quantity:Decimal, 
                         offset:float, 
                         limitPrice:float) -> Order:
    ...
    @staticmethod
    def MarketWithProtection(action:str, 
                             quantity:Decimal) -> Order:
    ...
    @staticmethod
    def StopWithProtection(action:str, 
                           quantity:Decimal, 
                           stopPrice:float) -> Order:
    ...
    @staticmethod
    def TrailingStop(action:str, 
                     quantity:Decimal, 
                     trailingPercent:float,
                     trailStopPrice:float) -> Order:
    ...
    @staticmethod
    def TrailingStopLimit(action:str, 
                          quantity:Decimal, 
    ...
    @staticmethod
    def ComboLimitOrder(action:str, 
                        quantity:Decimal, 
                        limitPrice:float, 
                        nonGuaranteed:bool) -> Order:
    ...
    @staticmethod
    def ComboMarketOrder(action:str, 
                         quantity:Decimal, 
                         nonGuaranteed:bool) -> Order:
    ...
    @staticmethod
    def LimitOrderForComboWithLegPrices(action:str, 
                                        quantity:Decimal,
                                        legPrices:list, 
                                        nonGuaranteed:bool) -> Order:
    ...
    @staticmethod
    def RelativeLimitCombo(action:str, 
                           quantity:Decimal, 
                           limitPrice:float, 
                           nonGuaranteed:bool) -> Order:
    ...
    @staticmethod
    def RelativeMarketCombo(action:str, 
                            quantity:Decimal, 
                            nonGuaranteed:bool) -> Order:
    ...
    # ! [oca]
    @staticmethod
    def OneCancelsAll(ocaGroup:str, 
                      ocaOrders:ListOfOrder, 
                      ocaType:int)  -> ListOfOrder:
    ...
    @staticmethod
    def Volatility(action:str, 
                   quantity:Decimal, 
                   volatilityPercent:float, 
                   volatilityType:int) -> Order:
    ...
    #! [fhedge]
    @staticmethod
    def MarketFHedge(parentOrderId:int, 
                     action:str) -> Order:
    
        #FX Hedge orders can only have a quantity of 0
        order = IBKROrder.MarketOrder(action, 0)
    ...
    @staticmethod
    def PeggedToBenchmark(action:str, 
                          quantity:Decimal, 
                          startingPrice:float, 
                          ...
                          referenceContractUpperRange:float)  -> Order:
    ...
    @staticmethod
    def AttachAdjustableToStop(parent:Order, 
                               attachedOrderStopPrice:float, 
                               triggerPrice:float, 
                               adjustStopPrice:float) -> Order:
    
        #! [adjustable_stop]
        # Attached order is a conventional STP order in opposite direction
        order = IBKROrder.Stop("SELL" if parent.action == "BUY" else "BUY",
    ...
    @staticmethod
    def AttachAdjustableToStopLimit(parent:Order, 
                                    attachedOrderStopPrice:float, 
                                    triggerPrice:float, 
                                    adjustedStopPrice:float, 
                                    adjustedStopLimitPrice:float) -> Order:
    ...
    @staticmethod
    def  AttachAdjustableToTrail(parent:Order, 
                                 attachedOrderStopPrice:float, 
                                 triggerPrice:float, 
                                 adjustedStopPrice:float, 
    ...
    @staticmethod
    def PriceCondition(triggerMethod:int, 
                       conId:int, 
                       exchange:str, 
                       price:float, 
                       isMore:bool, 
                       isConjunction:bool) -> PriceCondition:
    ...
    @staticmethod
    def ExecutionCondition(symbol:str, 
                           secType:str, 
                           exchange:str, 
                           isConjunction:bool) -> ExecutionCondition:
    ...
    @staticmethod
    def MarginCondition(percent:int, 
                        isMore:bool, 
                        isConjunction:bool) -> MarginCondition:
    ...
    @staticmethod
    def PercentageChangeCondition(pctChange:float, 
                                  conId:int, 
                                  exchange:str, 
                                  isMore:bool, 
                                  isConjunction:bool) -> PercentChangeCondition:
    ...
    @staticmethod
    def TimeCondition(time:str, 
                      isMore:bool, 
                      isConjunction:bool) -> TimeCondition:
    ...
    @staticmethod
    def LimitOrderWithManualOrderTime(action:str, 
                                      quantity:Decimal, 
                                      limitPrice:float, 
                                      manualOrderTime:str)  -> Order:

        # ! [limit_order_with_manual_order_time]
        order = IBKROrder.LimitOrder(action, quantity, limitPrice)
        order.manualOrderTime = manualOrderTime
        # ! [limit_order_with_manual_order_time]
        return order

    @staticmethod
    def PegBestUpToMidOrder(action:str, 
                            quantity:Decimal, 
                            limitPrice:float, 
                            minTradeQty:int, 
                            minCompeteSize:int, 
                            midOffsetAtWhole:float, 
                            midOffsetAtHalf:float) -> Order:
    ...
    @staticmethod
    def PegBestOrder(action:str, 
                     quantity:Decimal, 
                     limitPrice:float, 
                     minTradeQty:int, 
                     minCompeteSize:int, 
                     competeAgainstBestOffset:float) -> Order:
    ...
    @staticmethod
    def LimitOrderWithCustomerAccount(action:str, 
                                      quantity:Decimal, 
                                      limitPrice:float, 
                                      customerAccount:str) -> Order:
    ...
    @staticmethod
    def CancelOrderEmpty() -> OrderCancel:
        # ! [cancel_order_empty]
    ...
    @staticmethod
    def CancelOrderWithManualTime(manualOrderCancelTime: str) -> OrderCancel:
